...
import { LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquareIcon, SettingsIcon } from 'lucide-react'
...
const AdminSidebar = () => {
    ...
    const adminNavlinks = [
        ...
        { name: 'Control Panel', path: '/admin/control-panel', icon: SettingsIcon },
    ]
