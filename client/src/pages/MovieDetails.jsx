  ...
  return show ? (
    <div className='relative min-h-screen bg-black overflow-hidden'>
      ...
      <div className='relative z-10 px-6 md:px-12 lg:px-16 xl:px-20'>
          ...
          <div className='flex-1 space-y-6'>
            ...
            <div className={`transition-all duration-1000 delay-1000 ${
              ...
              <div className='flex flex-wrap items-center gap-4'>
                ...
                <button className='group flex items-center gap-3 px-6 py-3 bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-sm border border-white/20 hover:border-primary/40 transition-all duration-300 hover:scale-105'>
                  <div className='w-10 h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-primary/30 transition-all duration-300'>
        ...
        {/* Cast Section */}
        <div className={`py-16 transition-all duration-1000 delay-1200 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
        }`}>
            ...
            <div className='flex items-center gap-6 pb-4' style={{ width: 'max-content' }}>
              {show.movie.casts.slice(0, 12).map((cast, index) => (
                ...
                >
                  ...
                  <p className='text-white text-sm font-medium group-hover:text-primary transition-colors duration-300 max-w-[80px] truncate'>
                    {cast.name}
                  </p>
                </div>
              ))}
        ...
        <div className={`pb-16 transition-all duration-1000 delay-1400 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
        }`}>
        ...
        <div className={`py-16 transition-all duration-1000 delay-1600 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
        }`}>
